/**
 * Tests for the read-only tool-surface analyzer (`lib/analyze.mjs`).
 *
 * Usage: node test/analyze.test.mjs
 *
 ...
 * names, declarations it cannot parse, and 鈥?most importantly 鈥?that it never
